...
class User extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = 'Mappit : Dashboard';
    ...
    function userListing()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Mappit : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Mappit : Add New User';
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Mappit : Edit User';
    ...
    {
        $this->global['pageTitle'] = 'Mappit : Change Password';
    ...
    {
        $this->global['pageTitle'] = 'Mappit : 404 - Page Not Found';
    ...
    function addNewPoi() {
        ...
        {
            $this->global['pageTitle'] = 'Mappit : Add New Poi';
            $data = array();
            $this->loadViews("addnewpoi", $this->global, $data, NULL);
        }
    }

    function addNewPoiPost() {
        if($this->isAdmin() == TRUE)
        {
            $this->loadThis();
        }
    ...
    function editPOI($poi_id) {
        ...
        {
            $this->global['pageTitle'] = 'Mappit : Edit Poi';
            $data['poi'] = $this->poi_model->getPOIById($poi_id);
            $this->loadViews("editPoi", $this->global, $data, NULL);
        }
    }

    function editPOIPost($poi_id){
         if($this->isAdmin() == TRUE)
        {
            $this->loadThis();
        }
    ...
    function deletePOI($poi_id){
        ...
        else
        {
            ...
            $data['poi'] = $this->poi_model->deleteById($poi_id);
            redirect('/dashboard');
